...
#define NXP_CONFIG_TYPE_PN557 0x3U
 ...
 * NXP_GPIO_CHIP_PATH is a string; the pin entries are unsigned integers.
 * If absent from libnfc-nxp.conf the compiled-in defaults are used. */
